(function() {
    ...
    String.fromCodePoints = function(codepoints) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            if (current > 0xffff) {
                ...
                JSPlayer.log('String.fromCodePoints: current: ' + current + ', ' +
    ...
    String.fromUTF8 = function(bytes, terminatable) {
        ...
        while (index < length) {
            ...
            index += result.bytes;
            JSPlayer.log('String.fromUTF8: ' + result.bytes + ' bytes: ' +
                (result.codepoint == null ? '<nul>' : result.codepoint.toString(16)));
    ...
    JSPlayer.log = function(message) {
        if (window.console != null && typeof window.console.log == 'function') {
