(function() {
    ...
    function log(message) {
        JSPlayer.log('JSPlayer.File.ID3v2Reader.' + message);
    }
    ...
    function read(buffer) {
        ...
        readHeader(this, new JSPlayer.File.ForwardReader(headerView));

        bodyView = new Uint8Array(buffer, 10, this.size);
        bodyReader = new JSPlayer.File.ForwardReader(bodyView);
    ...
    JSPlayer.File.ID3v2Reader = ID3v2Reader;
})();
